...
<head>
    ...
    <!-- 配置文件 -->
    <script type="text/javascript" src="statics/ueditor.config.js"></script>
    <!-- 编辑器源码文件 -->
    <script type="text/javascript" src="statics/ueditor.all.js"></script>
    <style type="text/css">
        body {
            padding-top: 60px;
            padding-bottom: 40px;
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="font-size:25px">Myblog</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li <c:if test="${menu_page=='blog'}">class="active"</c:if>><a href="blog?actionName=view"><i class="glyphicon glyphicon-pencil"></i>&nbsp;发表博客</a></li>
...
<div class="container">
                ...
                <div>
                    <ul id="typeUl" class="nav nav-pills nav-stacked">
                        <c:forEach items="${typeInfo}" var="item">
                            <li id="li_${item.typeId}"><a href="index?actionName=searchType&typeId=${item.typeId}"><span id="sp_${item.typeId}">${item.typeName}</span><span class="badge">${item.noteCount}</span></a></li>
                        </c:forEach>
    ...
    <!--动态包含页面-->
    <!--云记列表-->
    <%--<jsp:include page="blog/list.jsp"></jsp:include>--%>
    <!--个人中心-->
